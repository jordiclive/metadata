...
class UrlProcessor(MetadataProcessor):
    ...
    def process_global(self, metadata_attrs: Dict[str, Any]) -> Optional[str]:
        ...
        return "".join([self.cfg.prefix_sep_tokens['url'], self.cfg.metadata_key_value_sep, unquote_plus(metadata_attrs["value"])])
...
class WebsiteDescriptionProcessor(MetadataProcessor):
    ...
    def process_global(self, metadata_attrs: Dict[str, Any]) -> Optional[str]:
        ...
        return "".join([self.cfg.prefix_sep_tokens['website_description'], self.cfg.metadata_key_value_sep, metadata_attrs["value"]])
...
class DatasourceProcessor(MetadataProcessor):
    ...
    def process_global(self, metadata_attrs: Dict[str, Any]) -> Optional[str]:
        ...
        return "".join([self.cfg.prefix_sep_tokens['datasource'], self.cfg.metadata_key_value_sep, metadata_attrs["value"]])
...
class GenerationLengthProcessor(MetadataProcessor):
    ...
    def process_global(self, metadata_attrs: Dict[str, Any]) -> Optional[str]:
        ...
        return "".join([self.cfg.prefix_sep_tokens['text_length'], self.cfg.metadata_key_value_sep, metadata_attrs["value"]])
