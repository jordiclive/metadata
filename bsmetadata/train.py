...
def main(args: CFG) -> None:
    ...
    path = Path("/fsx/home-jordiclive/tmp/metadata-html-quarter/checkpoint-14000step").resolve()
    ...
    metrics_logger = Logger(is_local_main_process, name=f"80gb-0.25-html-all-metadata-,{args.learning_rate}-{t_bs}",entity='jordanclive',project='metadata', config=config_dict)
