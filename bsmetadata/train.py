...
def main(args: CFG) -> None:
    ...
    metrics_logger = Logger(is_local_main_process, name=f"80gb-no-entity-paragraph,{args.learning_rate}-{t_bs}",entity='jordanclive',project='metadata', config=config_dict)
