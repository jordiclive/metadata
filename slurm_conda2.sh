...
srun accelerate launch --config_file accelerate_config.yaml bsmetadata/train.py --config-name v2 --main_process_ip $MASTER_ADDR --main_process_port $MASTER_PORT \
  model_name=$MODEL \
